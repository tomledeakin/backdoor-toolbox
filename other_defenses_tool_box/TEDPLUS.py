import torch
torch.cuda.empty_cache()  # Giải phóng bộ nhớ ngay từ đầu (nếu cần)
...
if torch.cuda.is_available():
    ...
    torch.cuda.empty_cache()  # Giải phóng bộ nhớ ngay sau khi seed
...
class TEDPLUS(BackdoorDefense):
    ...
    def test(self):
        ...
        pca = PCA(contamination=0.05, n_components=2)
