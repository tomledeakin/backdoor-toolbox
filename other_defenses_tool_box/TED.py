...
class TED(BackdoorDefense):
    def __init__(self, args):
        ...
        ########################################################################
        # ---------------------- FILTER 30 RANDOM CLASSES (INCLUDING TARGET CLASS) ----------------------
        all_test_labels = []
        ...
        if len(unique_test_labels) > 50:
            # Nếu target_class chưa có trong unique_test_labels thì thêm vào để đảm bảo
            ...
            selected_classes = random.sample(temp_labels, 29)  # Lấy 29 lớp khác target_class
            ...
            # Lọc chỉ mục thuộc về các lớp đã chọn
