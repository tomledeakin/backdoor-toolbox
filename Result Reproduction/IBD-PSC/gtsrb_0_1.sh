...
python other_defense.py -defense=ScaleUp -dataset=cifar10 -poison_type=badnet -poison_rate=0.1
...
# python all_layers_resnet18_layer_visualize.py -dataset=cifar10 -poison_type=badnet -poison_rate=0.1
...
# python all_layers_resnet18_layer_visualize.py -dataset=cifar10 -poison_type=adaptive_patch -poison_rate=0.1 -cover_rate=0.05 -n_neighbors=50
