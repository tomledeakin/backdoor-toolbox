#!/bin/bash
#SBATCH --job-name=cifar10_adaptive_patch
#SBATCH --output=logs/cifar10_adaptive_patch_output.log
#SBATCH --error=logs/cifar10_adaptive_patch_error.log
...
# python resnet18_layer_visualize.py -dataset=cifar10 -poison_type=adaptive_patch -poison_rate=0.1 -cover_rate=0.05 -n_neighbors=50
