parser_choices = {
    ...
    'dataset': ['gtsrb', 'cifar10', 'cifar100', 'imagenette', 'ember', 'imagenet', 'imagenet50', 'imagenet100', 'imagenet200'],
    'poison_type': [  # Poisoning attacks
        ...
        # Other attacks
        'trojannn', 'BadEncoder', 'SRA', 'bpp', 'WB', 'SSDT'],
    ...
    'defense': ['ABL', 'NC', 'STRIP', 'FP', 'NAD', 'SentiNet', 'ScaleUp', 'SEAM', 'SFT', 'NONE', 'Frequency', 'AC', 'moth', 'IBAU', 'ANP', 'FeatureRE', 'AWM', 'RNP', 'CD', 'BaDExpert', 'IBD_PSC', 'TED', 'FOLD', 'TED++', 'EXP'],
}
