...
python create_poisoned_set.py -dataset=tinyimagenet200 -poison_type=adaptive_patch -poison_rate=0.1
python train_on_poisoned_set.py -dataset=tinyimagenet200 -poison_type=adaptive_patch -poison_rate=0.1 -resume_from_meta_info
