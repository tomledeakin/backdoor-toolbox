...
# python other_defense.py -defense=TED -dataset=cifar10 -poison_type=adaptive_blend -poison_rate=0.1 -cover_rate=0.05 -validation_per_class=2 -num_test_samples=50 
...
# python other_defense.py -defense=IBD_PSC -dataset=cifar10 -poison_type=trojan -poison_rate=0.1 -validation_per_class=2 -num_test_samples=50  
