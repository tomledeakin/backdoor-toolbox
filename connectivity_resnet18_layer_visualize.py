...
import umap.plot  # Thêm import để vẽ connectivity
...
for vid, path in enumerate(model_list):
    ...
    for layer_name in layer_outputs.keys():
        ...
        # Save the scatter figure
        plt.savefig(save_path, dpi=300)
        print(f"Saved figure at {save_path}")
        plt.clf()

        # Plot UMAP connectivity
        ...
        umap.plot.connectivity(visualizer, show_points=True)
